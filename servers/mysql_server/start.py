...
This script starts the MySQL MCP server with proper configuration and signal handling.
"""
...
from servers.mysql_server.server import MySQLMCPServer


async def main():
    """Main function to start the MySQL MCP server"""
