    ...
    async def generate_resume(self, resume_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if resume_id:
                ...
                download_result = await self._make_request('GET', f'/resumes/{resume_id}')
                ...
                return {
                    "error": True,
                    "message": "No resume ID returned from API"
                }
    ...
    async def get_resume_api_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "api_info": result if not result.get('error') else "API info not available"
            }
            ...
            return {
                "error": True,
                "message": f"Error getting API info: {str(e)}"
            }
